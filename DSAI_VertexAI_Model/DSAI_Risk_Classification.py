...
def DriverRiskClassification():
    ...
    with col4:
        ...
        vAR_submit = vAR_st.button("Predict Driver Risk Classification")
    ...
    if vAR_submit:
        ...
        "Age":str(vAR_age)}
        vAR_risk_score = RiskScorePredictionAPI(os.environ["PROJECT_ID"],os.environ["CLASSIFICATION_ENDPOINT_ID"],vAR_payload)
